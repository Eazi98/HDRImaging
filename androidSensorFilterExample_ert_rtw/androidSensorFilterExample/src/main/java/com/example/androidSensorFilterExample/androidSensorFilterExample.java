package com.example.androidSensorFilterExample;
...
import com.example.androidSensorFilterExample.databinding.ActivityMainBinding;
...
public class androidSensorFilterExample extends AppCompatActivity implements SensorEventListener, OnFragmentInteractionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.androidSensorFilterExample.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
    ...
    private androidSensorFilterExample thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","androidSensorFilterExample"};
    ...
    private native int naMain(String[] argv, androidSensorFilterExample pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("androidSensorFilterExample");
    }
