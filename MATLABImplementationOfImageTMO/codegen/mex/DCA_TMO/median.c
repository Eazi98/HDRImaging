...
static emlrtRSInfo he_emlrtRSI = {
    ...
    "median", /* fcnName */
    "C:\\Program "
    "Files\\MATLAB\\R2022b\\toolbox\\eml\\lib\\matlab\\datafun\\median.m" /* pathName
                                                                           */
};
...
static emlrtRSInfo ie_emlrtRSI = {
    ...
    "vmedian", /* fcnName */
    "C:\\Program "
    "Files\\MATLAB\\R2022b\\toolbox\\eml\\lib\\matlab\\datafun\\private\\vmedia"
    "n.m" /* pathName */
};
...
static emlrtRTEInfo ad_emlrtRTEI = {
    ...
    "median", /* fName */
    "C:\\Program "
    "Files\\MATLAB\\R2022b\\toolbox\\eml\\lib\\matlab\\datafun\\median.m" /* pName
                                                                           */
};
...
real_T median(const emlrtStack *sp, const emxArray_real_T *x)
{
  ...
  if (x->size[1] == 0) {
    ...
    k = 0;
    emxInit_real_T(&st, &a__4, 2, &ad_emlrtRTEI);
    int32_T exitg1;
    do {
      exitg1 = 0;
      if (k <= vlen - 1) {
        ...
        if (vlen <= 4) {
          ...
          if ((vlen & 1) == 0) {
            ...
            emxEnsureCapacity_real_T(&st, a__4, a__6, &yc_emlrtRTEI);
            a__4_data = a__4->data;
            k = x->size[1];
            ...
            a__4->size[0] = 1;
            a__4->size[1] = x->size[1];
            emxEnsureCapacity_real_T(&st, a__4, a__6, &xc_emlrtRTEI);
            a__4_data = a__4->data;
            k = x->size[1];
            for (a__6 = 0; a__6 < k; a__6++) {
              a__4_data[a__6] = x_data[a__6];
