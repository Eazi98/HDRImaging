...
//
// Arguments    : ::coder::array<real_T, 2U> &x
// Return Type  : void
//
namespace coder {
namespace internal {
void sort(::coder::array<real_T, 2U> &x)
{
...
// Return Type  : void
//
void sort(::coder::array<real_T, 1U> &x)
{
  array<real_T, 1U> b_xwork;
  array<real_T, 1U> vwork;
  array<real_T, 1U> xwork;
  array<int32_T, 1U> b_iwork;
