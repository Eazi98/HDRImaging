...
//    public double[][] quantizeNL_float_matrix(SimpleMatrix y, double nclust, SimpleMatrix lum) {
//
//        SimpleMatrix lum0 = lum;
//
//        int numelLum = lum.getNumElements();
//        double[][] lumArray = matrix2Array(lum);
//        sort(lumArray);
//        SimpleMatrix lum1D = new SimpleMatrix(
//                lumArray
//        );
//        lum1D.reshape(1,numelLum);
//
//        double[][] yArray = matrix2Array(y);
//        sort(yArray);
//        SimpleMatrix y1D = new SimpleMatrix(
//                yArray
//        );
//        int numelY = y1D.getNumElements();
//        y1D.reshape(1,numelY);
//
//        double[] edges = new double[]{0, y1D.getNumElements()};
//        double[] errorsPow = new double[y1D.getNumElements()];
//
//        double meanOfY = y1D.elementSum()/y1D.getNumElements();
//        for (int i = 0; i < y1D.getNumElements(); i++){
//            errorsPow[i] = Math.pow((y1D[i]-meanOfY),2);
//        }
//        double[] errors = sum(errorsPow);
//        errorsPow = null;
